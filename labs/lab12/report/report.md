...
![Написанная программа 1](image/1.png){#fig:001 width=70%}
...
![Написання программа 2](image/3.png){#fig:002 width=70%}
...
![Написанная программа программа 3](image/5.png){#fig:003 width=70%}
...
![Написанная программа 4](image/7.png){#fig:004 width=70%}

И после того как я написала программу в файле, я могу его запустить bash <имя командного файла> <аргументы> 
